...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("DinosaurCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("DinosaurCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DinosaurCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"23.254.97.249", "23.254.97.249"}, //Main DinosaurCoin Seed Node
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("DinosaurCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("DinosaurCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("DinosaurCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("DinosaurCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DinosaurCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("DinosaurCoin-start");
